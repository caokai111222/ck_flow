export const helper = {
  formName: {
    title: '表单名称',
    content: '表单名称,一般与流程名称一致,如:差旅报销流程'
  },
  formCode: {
    title: '表单编号',
    content: '表单唯一识别编号'
  ...
  timeformat: {
    ...
    content: '时间的格式化显示类型',
    type: 'select',
    data: [{ value: 'HH:mm:ss', label: 'HH:mm:ss' }]
  },
  minute: {
    title: '分钟倍数',
    content: '分钟倍数',
...
/*  tagattr: {
  ...
  sourceType: {
    ...
    content: '数据来源',
    type: 'select',
    data: [{ value: 'dict', label: '数据字典' }, { value: 'userInput', label: '人工输入' }/*, { value: 'sourceApi', label: '后台接口' }*/]
  },
  dictType: {
    title: '数据字典类型',
    content: '数据字典类型',
  ...
  ctrlSpan: {
    ...
    content: '控件占整行的列数',
    type: 'slider',
    data: [{ value: 1, label: 'min' }, { value: 24, label: 'max' }]
  },
  spans: {
    title: '占整行比例',
    content: '占整行的列数',
...
/*  isRemote: {
  ...
  fileSize: {
    title: '文件大小',
    content: '最大上传的文件大小（MB）',
    type: 'number'
  },
  fileType: {
    title: '文件类型',
    content: '支持的文件类型后缀名，以,分割，比如 jpg,gif,bmp'
  },
  isShowTip: {
    title: '显示提示',
    content: '是否显示提示文本',
